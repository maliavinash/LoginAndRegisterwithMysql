...
import com.avinash.loginandregister.app.AppConfig;
import com.avinash.loginandregister.app.AppController;
import com.avinash.loginandregister.helper.SQLiteHandler;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnRegister.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ...
                if (!fname.isEmpty() && !lname.isEmpty() && !email.isEmpty() && !mobile.isEmpty() && !password.isEmpty()) {
